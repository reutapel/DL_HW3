...
cmd:option('-earlyStop',          30,                        'number of bad epochs to stop after')
cmd:option('-optimization',       'rmsprop',                   'optimization method')
cmd:option('-gradClip',           5,                           'clip gradients at this value')
cmd:option('-epoch',              2,                         'number of epochs to train')
cmd:option('-epochDecay',         1,                           'number of epochs to start decay learning rate')
...
cmd:option('-load',               '/home/reutapel@st.technion.ac.il/DL_HW3/Results/Net_1.t7',                          'load existing net weights')
